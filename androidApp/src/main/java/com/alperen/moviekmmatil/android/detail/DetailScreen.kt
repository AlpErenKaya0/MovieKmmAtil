...
import com.alperen.moviekmmatil.android.R
import com.alperen.moviekmmatil.android.Red
            ...
            AsyncImage(model = movie.imageUrl,
                ...
                Column(modifier = modifier
                    ...
                    Button(
                        ...
                        Icon(painter= painterResource(id = R.drawable.play_button),contentDescription = null,
                        tint = Color.White
                        )
                        Spacer(modifier = modifier.width(8.dp))
                        Text(text = "Start Watch",color = Color.White)
                    }
